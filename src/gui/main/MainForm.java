...
public class MainForm extends JPanel {
    ...
    private void createUIComponents() {
        ...
        titlePanel = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                /*if (mePhoto != null)*/ {
                    int inset = 2;
                    BufferedImage image = Helper.makeCircle(Helper.getPhoto(mePhoto, true));
        ...
        buddyPanel = new JPanel() {
            ...
            protected void paintComponent(Graphics graphics) {
                ...
                if(buddySelected) {
                    ...
                    /*if (buddyPhoto != null)*/ {
                        int inset = 2;
                        BufferedImage image = Helper.makeCircle(Helper.getPhoto(buddyPhoto, true));
    ...
    public boolean isBuddySelected() {
        return buddySelected;
    }

    public void setBuddySelected(boolean buddySelected) {
        if(this.buddySelected != buddySelected) {
            this.buddySelected = buddySelected;
            repaint();
        }
    }
